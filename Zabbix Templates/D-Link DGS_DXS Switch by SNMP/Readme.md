...
## Source
This template is based on the built-in Zabbix template *D-Link DES_DGS Switch by SNMP*.<br>

## Compatibility
This template is designed for monitoring D-Link DGS and DXS switches via SNMP.<br>
